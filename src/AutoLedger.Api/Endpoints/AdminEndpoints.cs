...
public static class AdminEndpoints
{
    public static void MapAdminEndpoints(this WebApplication app)
    {
        ...
        userGroup.MapPost("/expense-category", [Authorize(Roles = "Admin, SuperAdmin")]
        ...
        userGroup.MapDelete("/expense-category", [Authorize(Roles = "Admin, SuperAdmin")]
        ...
        userGroup.MapPut("/expense-category", [Authorize(Roles = "Admin, SuperAdmin")]
